...

    {
...

        {
            ...
            while (rdr.Read())
            {
                    Label b = new Label();
                    Panel p1 = new Panel();
                    RJCircularPictureBox I1 = new RJCircularPictureBox();

                    b.Text = rdr["Login"].ToString();
                    b.Name = rdr["idUsuario"].ToString();
                    b.Size = new System.Drawing.Size(175, 25);
                    b.Font = new System.Drawing.Font("Microsoft Sans Serif", 14, FontStyle.Bold);
                    b.BackColor = Color.FromArgb(3, 36, 100);
                    b.ForeColor = Color.White;
                    b.Dock = DockStyle.Bottom;
                    b.TextAlign = ContentAlignment.MiddleCenter;
                    b.Cursor = Cursors.Hand;
                    b.Padding = new Padding(1);
                    p1.Size = new System.Drawing.Size(155, 180);
                    p1.BorderStyle = BorderStyle.None;
                    p1.BackColor = Color.FromArgb(3, 36, 100);


                    I1.Size = new System.Drawing.Size(100, 100);
                    ...
                    I1.BorderSize = 3;
                        I1.BorderLineStyle = DashStyle.Custom;
       ...
       private void validarLicencia()
        ...
        private void enviarCorreo()
        {
            ...
            String pass = Bases.Desencriptar(lblResultadoContraseña.Text);
            richTextBox1.Text = richTextBox1.Text.Replace("@pass", pass);
          

            Bases.enviarCorreo("managebestsellers@gmail.com", "hrkr nfvv ntkb ppnq", richTextBox1.Text, "Solicitud de Contraseña",  txtcorreo.Text, "");
      ...
      private void validar_conexion()
        ...
        private void timerValidarRol_Tick(object sender, EventArgs e)
        {
            ...
            {
                BackColor = Color.FromArgb(3, 36, 100);
        ...
        private void PdeCarga_Click(object sender, EventArgs e)
        {
