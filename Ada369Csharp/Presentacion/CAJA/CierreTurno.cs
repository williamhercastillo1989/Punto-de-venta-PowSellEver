       ...
       private void mostrarCorreoBase()
        ...
        private void enviarcorreo()
        {
            if (checkCorreo.Checked==true)
            {
                ReemplazarHtml();
                bool estado;
                estado = Bases.enviarCorreo(correobase, contraseña, htmldeEnvio.Text, "Cierre de caja PowSellEver", txtcorreo.Text, "");
                if (estado == true)
                {
        ...
        public void ReemplazarHtml()
        {
            ...
            htmldeEnvio.Text = htmldeEnvio.Text.Replace("@compras_totales", CIERRE_DE_CAJA.compras.ToString());
