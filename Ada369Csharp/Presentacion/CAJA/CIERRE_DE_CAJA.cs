...
namespace Ada369Csharp.Presentacion.CAJA
{
    public partial class CIERRE_DE_CAJA : Form
    {
        ...
        private void mostrar_compras_por_turno()
        {
            Obtener_datos.mostrar_compras_por_turno(idcaja, fechaInicial, fechafinal, ref compras);
            lblResultadoCompras.Text = compras.ToString();
        }
