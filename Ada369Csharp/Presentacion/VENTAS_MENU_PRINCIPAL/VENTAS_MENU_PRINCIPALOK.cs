    ...
    public partial class VENTAS_MENU_PRINCIPALOK : Form
    {
        ...
        private void Mostrar_empresa()
        {
            ...
            foreach (DataRow row in dt.Rows)
            {
                ...
                porcentaje_impuesto = Convert.ToDecimal(row["Porcentaje_impuesto"].ToString());
        ...
        private void sumar()
        {
            try
            {
                ...
                foreach (DataGridViewRow fila in dgDetalleventa.Rows)
                {
                    ...
                    {
                        decimal iva = Convert.ToDecimal(totalpagar) * porcentaje_impuesto / 100;
                        decimal finalIva = Convert.ToDecimal(totalpagar) - iva;
                   
                        lblsubtotal.Text = finalIva.ToString();
                        lbligv.Text = iva.ToString();
                    }
        ...
        private void vender_por_teclado()
        {
            ...
            if (sevendePor.Trim() == "Granel")
            {
                vender_a_granel();
            }
            else if (sevendePor.Trim() == "Unidad")
            {
                txtpantalla = 1;
                vender_por_unidad();
            }
        ...
        private void mostrar_roles()
        {
            ...
            com.CommandType = CommandType.StoredProcedure;
            com.Parameters.AddWithValue("@idusario", idusuario_que_inicio_sesion);
            ...
            try
            {
                ...
                string lblRol = Convert.ToString(com.ExecuteScalar());
                if (lblRol == "Administrador (Control total)")
                {
        ...
        private void EventosNavegarDgproductos(KeyEventArgs e)
        {
            ...
            {
                if (e.KeyCode == Keys.F3 && EstadoCobrar == true)
                {
                    Cobrar();
                }
        ...
        private void StatusStrip4_ItemClicked(object sender, ToolStripItemClickedEventArgs e)
        {
